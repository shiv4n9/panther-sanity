...
/**
 * HistoryPanel — Inline bottom panel showing historical trend data.
 * Appears below the data table when a throughput value is clicked.
 */
const HistoryPanel = ({ isOpen, onClose, testCase, platform, category, currentValue }) => {
  ...
  const accent = is400
    ? { from: '#10b981', to: '#059669', bg: 'emerald', hex: '#10b981' }
  ...
  return (
    <div ref={panelRef} className="animate-fade-in-up rounded-2xl shadow-xl border border-juniper/15 overflow-hidden bg-[#f7faf4] mt-4">
      {/* Accent bar */}
      <div className="h-1 w-full" style={{ background: `linear-gradient(90deg, ${accent.from}, ${accent.to}, ${accent.from})` }} />

      {/* Header */}
      <div className="px-6 py-4 border-b border-juniper/15 bg-[#f7faf4]">
        <div className="flex items-start justify-between gap-4">
          <div className="flex-1 min-w-0">
            ...
            {/* Title */}
            <h2 className="text-lg font-bold text-slate-900 leading-tight">{testCase}</h2>
            ...
            {currentValue && (
              <div className="flex items-center gap-3 mt-2">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="font-jetbrains text-sm font-bold text-slate-800 bg-white px-2 py-0.5 rounded border border-slate-200">
                    {currentValue}
                  </span>
                </div>
          ...
          <button onClick={onClose} className="p-2 -mt-1 -mr-2 rounded-lg hover:bg-white/60 text-slate-400 hover:text-slate-600 transition-colors">
        ...
        <div className="grid grid-cols-[1fr_3fr] gap-4">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
              ...
              <p className="text-xl font-extrabold text-blue-600 font-jetbrains">{stats.min}</p>
            </div>
            ...
            <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
              ...
              <p className="text-xl font-extrabold text-emerald-600 font-jetbrains">{stats.max}</p>
            </div>
            ...
            {stats.latestRelease && (
              <div className="bg-white rounded-xl p-4 border border-slate-200 shadow-sm">
                <div className="flex items-center gap-1.5 mb-1.5">
                  ...
                  <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">Release</p>
                </div>
                <p className="text-xs font-bold text-slate-700 font-jetbrains truncate" title={stats.latestRelease}>{stats.latestRelease}</p>
              </div>
            )}
          </div>
